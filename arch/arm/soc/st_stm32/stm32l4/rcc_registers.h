...
#ifndef _STM32L4X6_CLOCK_H_
#define _STM32L4X6_CLOCK_H_
...
enum {
	STM32L4X6_RCC_CFG_PLL_SRC_MSI	  = 0x1,
	STM32L4X6_RCC_CFG_PLL_SRC_HSI     = 0x2,
	STM32L4X6_RCC_CFG_PLL_SRC_HSE     = 0x3,
};

enum {
	STM32L4X6_RCC_CFG_PLL_Q_R_0	= 0x1,
	STM32L4X6_RCC_CFG_PLL_Q_R_2	= 0x2,
};

enum {
	STM32L4X6_RCC_CFG_SYSCLK_SRC_MSI   = 0x0,
	STM32L4X6_RCC_CFG_SYSCLK_SRC_HSI   = 0x1,
	STM32L4X6_RCC_CFG_SYSCLK_SRC_HSE   = 0x2,
	STM32L4X6_RCC_CFG_SYSCLK_SRC_PLL   = 0x3,
};

enum {
	STM32L4X6_RCC_CFG_HCLK_DIV_0  = 0x0,
	STM32L4X6_RCC_CFG_HCLK_DIV_2  = 0x4,
	STM32L4X6_RCC_CFG_HCLK_DIV_4  = 0x5,
	STM32L4X6_RCC_CFG_HCLK_DIV_8  = 0x6,
	STM32L4X6_RCC_CFG_HCLK_DIV_16 = 0x7,
};

enum {
	STM32L4X6_RCC_CFG_SYSCLK_DIV_0	 = 0x0,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_2	 = 0x8,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_4	 = 0x9,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_8	 = 0xa,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_16	 = 0xb,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_64	 = 0xc,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_128 = 0xd,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_256 = 0xe,
	STM32L4X6_RCC_CFG_SYSCLK_DIV_512 = 0xf,
};

enum {
	STM32L4X6_RCC_CFG_MCO_DIV_0  = 0x0,
	STM32L4X6_RCC_CFG_MCO_DIV_2  = 0x1,
	STM32L4X6_RCC_CFG_MCO_DIV_4  = 0x2,
	STM32L4X6_RCC_CFG_MCO_DIV_8  = 0x3,
	STM32L4X6_RCC_CFG_MCO_DIV_16 = 0x4,
};
...
union __rcc_cr {
	...
	struct {
		...
		uint32_t pllsai3on :1 __packed;
		uint32_t pllsai3rdy :1 __packed;
