...
static struct spi_stm32lx_config spi_stm32lx_cfg_1 = {
	.base = (uint8_t *)SPI1_BASE,
#ifdef CONFIG_SOC_SERIES_STM32L4X
	.clock_subsys = UINT_TO_POINTER(STM32L4X_CLOCK_SUBSYS_SPI1),
#endif
#ifdef CONFIG_SPI_STM32LX_INTERRUPT
...
{
#ifdef CONFIG_SOC_SERIES_STM32L4X
#define PORT_1_IRQ STM32L4_IRQ_SPI1
#endif
...
static struct spi_stm32lx_config spi_stm32lx_cfg_2 = {
	.base = (uint8_t *)SPI2_BASE,
#ifdef CONFIG_SOC_SERIES_STM32L4X
	.clock_subsys = UINT_TO_POINTER(STM32L4X_CLOCK_SUBSYS_SPI2),
#endif
#ifdef CONFIG_SPI_STM32LX_INTERRUPT
...
{
#ifdef CONFIG_SOC_SERIES_STM32L4X
#define PORT_2_IRQ STM32L4_IRQ_SPI2
#endif
...
static struct spi_stm32lx_config spi_stm32lx_cfg_3 = {
	.base = (uint8_t *)SPI3_BASE,
#ifdef CONFIG_SOC_SERIES_STM32L4X
	.clock_subsys = UINT_TO_POINTER(STM32L4X_CLOCK_SUBSYS_SPI3),
#endif
#ifdef CONFIG_SPI_STM32LX_INTERRUPT
...
{
#ifdef CONFIG_SOC_SERIES_STM32L4X
#define PORT_3_IRQ STM32L4_IRQ_SPI3
#endif
	IRQ_CONNECT(PORT_3_IRQ, CONFIG_SPI_3_IRQ_PRI,
